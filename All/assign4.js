function set_string() {
    ...
    var string2 = document.getElementById("st2").value; com1(string1, string2);
    com2(string1, string2); com3(string1, string2); com4(string1, string2);
...
function com2(string1, string2) {
    ...
    const pattern = new RegExp(string1, "gi"); var ot;
    // compare the stings
...
function com3(string1, string2) {
    ...
    // program to perform case insensitive string comparison var ot;
